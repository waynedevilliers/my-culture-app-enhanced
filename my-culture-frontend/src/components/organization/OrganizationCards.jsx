  ...
  return (
    ...
    >
          ...
          <div className="relative overflow-hidden h-56">
            {organization.Image?.url ? (
              <img
                ...
                alt={`${organization.name} - ${t('organizationDetails.culturalOrganization')}`}
              ...
              <div className="w-full h-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  <div className="text-4xl mb-2" role="img" aria-label="Building">🏢</div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* Meta information */}
        <address className="flex items-center gap-4 mb-4 text-xs text-gray-500 not-italic">
        ...
        <footer className="mt-auto">
          <Link
            ...
            aria-label={`${t('organizations.exploreOrganization')}: ${organization.name}`}
          >
